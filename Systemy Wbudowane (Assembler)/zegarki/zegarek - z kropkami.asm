...
;wyswietlanie kropek przy aktualnie zmienianej liczbie
	jnb CONFIG, displayService_pomin_kropki

	cjne R7, #00000001b, displayService_2
	cjne R2, #1, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki
displayService_2:
	cjne R7, #00000010b, displayService_3
	cjne R2, #1, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki
displayService_3:
	cjne R7, #00000100b, displayService_4
	cjne R2, #2, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki
displayService_4:
	cjne R7, #00001000b, displayService_5
	cjne R2, #2, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki
displayService_5:
	cjne R7, #00010000b, displayService_6
	cjne R2, #3, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki
displayService_6:
	cjne R7, #00100000b, displayService_pomin_kropki
	cjne R2, #3, displayService_pomin_kropki
	mov DPTR, #wzory_kropka
	sjmp displayService_kropki

displayService_pomin_kropki:
	mov DPTR, #wzory     ;wzorek odpowiadajacy cyfrze zegarka
displayService_kropki:
...
wzory_kropka:
	db	10111111b, 10000110b
	db	11011011b, 11001111b
	db	11100110b, 11101101b
	db	11111101b, 10000111b
	db	11111111b, 11101111b
	db	11110111b, 11111100b
	db	11011000b, 11011110b
	db	11111001b, 11110001b
